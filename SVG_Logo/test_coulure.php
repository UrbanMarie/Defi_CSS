...
<body>
    ...
    <div class="coulureanim">
         <!-- <object id="logo" type="image/svg+xml" data="element9.svg"></object> -->
        <svg id="logo" width="600px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
       	 viewBox="0 0 600 600" style="enable-background:new 0 0 600 600;" xml:space="preserve">

         <g stroke="black" stroke-width="2.5" stroke-miterlimit="3">
        <!-- premier mot  -->
        ...
        <!-- point-->
        <g stroke="black" stroke-width="9" stroke-miterlimit="10" fill="none">
